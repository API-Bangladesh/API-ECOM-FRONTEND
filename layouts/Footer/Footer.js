...
export default function Footer() {
  ...
  const linkIconMap = {
    'facebook': <FaFacebookF size="20px" className="footer-soical-link ms-2" />,
    'twitter': <FaTwitter size="20px" className="footer-soical-link ms-2" />,
    'linkedin': <FaLinkedinIn size="20px" className="footer-soical-link ms-2" />,
    'youtube': <FaYoutube size="20px" className="footer-soical-link ms-2" />,
    'instagram': <AiOutlineInstagram size="20px" className="footer-soical-link ms-2" />,
    'default': <FaLink size="20px" className="footer-soical-link ms-2" />,
  };
