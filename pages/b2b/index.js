      ...
      <section>
        ...
        <Container>
          <Row>
            <Col lg={12}>
              <div className="">
                <h2 className="text-center my-4 font-jost font-30 fw-bold text-secondary">
                  B2B Business Form{" "}
                </h2>
              </div>
            </Col>
            <Col lg={8} className="btob-forms">
              <div className="">
                <p className="float-left font-jost font-16 mb-4">
                  ...
                  you have any inquiries on bulk order for your business. Our responsible person will contact you as soon as
